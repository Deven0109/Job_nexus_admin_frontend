...
const CandidateManagement = () => {
    ...
    const handleCreateUser = async (e) => {
        ...
        try {
            ...
            const msg = error.response?.data?.message || 'Failed to create candidate';
            toast.error(msg);
        } finally {
    ...
    const handleUpdateUser = async (e) => {
        ...
        try {
            ...
            const msg = error.response?.data?.message || 'Failed to update candidate';
            toast.error(msg);
        } finally {
            setFormLoading(false);
        }
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h2 className="text-xl font-bold text-dark-900">Candidate Management</h2>
                    <p className="text-sm text-dark-500 mt-0.5">
                        Manage platform candidates
                    </p>
                </div>
                <button
                            ...
                            {fetchError && users.length === 0 ? (
                                <tr>
                                    <td colSpan="5" className="px-5 py-12 text-center">
                                        ...
                                        <p className="text-dark-900 font-bold mb-1">Failed to load candidates</p>
